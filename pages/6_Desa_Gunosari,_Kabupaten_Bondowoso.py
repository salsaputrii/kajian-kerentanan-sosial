...
st.set_page_config(page_title="Desa Gunosari, Kecamatan Tlogosari, Kabupaten Bondowoso", page_icon=":round_pushpin:", layout="wide")
st.markdown("<h1 style='text-align: center'>Analisis Desa Gunosari, Kabupaten Bondowoso</h1>"
...
<a href='#peta-persil-desa-gunosari'>
<button
...
<a href='#persebaran-responden-desa-gunosari'>
<button
...
<a href='#peta-batas-administratif-desa-gunosari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-batas-hutan-desa-gunosari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px">
Peta Batas Hutan
</button>
...
<a href='#peta-klasifikasi-gender-kepemilikan-lahan-desa-gunosari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-jangkauan-terhadap-kantor-desa-gunosari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-kelerengan-desa-gunosari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Peta Kelerengan
</button>
...
<a href='#peta-klasifikasi-luas-persil-desa-gunosari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-klasifikasi-petani-gurem-desa-gunosari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Peta Petani Gurem
</button>
...
<a href='#peta-tata-guna-lahan-desa-gunosari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#pemeringkatan-level-risiko-desa-gunosari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#desa-yang-berada-di-klaster-yang-sama-dengan-desa-gunosari-klaster-5'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Desa yang Mirip dengan Gunosari
</button>
</a>
...
# PETA PERSIL
st.header(":arrow_forward: Peta Persil Desa Gunosari")
coba_map = gpd.read_file('bondowoso_gunosari/Bondowoso_Gunosari.shp').to_crs(epsg=4326)
...
st.header(":arrow_forward: Persebaran Responden Desa Gunosari")
col1, col2 = st.columns([1.5, 1.5])
col1.markdown("")
labels = 'Kelompok Non rentan', 'Lokasi Khusus', 'KTP Luar', 'Pendatang', 'Belum Mendapat Kuota', 'Kelompok Rentan', 'Konflik'
sizes = [1, 2, 0, 2, 0, 21, 4]
colors = ['#006700', '#5b9a01', '#80b145', '#ffff00', '#ffbe00', '#ff7701', '#ff2602']
...
# PETA BATAS ADMINISTRATIF
st.header(":arrow_forward: Peta Batas Administratif Desa Gunosari")
administratif = Image.open('bondowoso_gunosari/PETA B. ADMINISTRASI GUNOSARI BONDOWOSO.jpg')
st.image(administratif)

# PETA BATAS HUTAN
st.header(":arrow_forward: Peta Batas Hutan Desa Gunosari")
batas_hutan = Image.open('bondowoso_gunosari/PETA B.HUTAN GUNOSARI BONDOWOSO.jpg')
st.image(batas_hutan)

# PETA GENDER
st.header(":arrow_forward: Peta Klasifikasi Gender Kepemilikan Lahan Desa Gunosari")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
gender = Image.open('bondowoso_gunosari/PETA KLASIFIKASI GENDER DESA GUNOSARI.jpg')
col1.image(gender)
col2.markdown("")
...
st.header(":arrow_forward: Peta Jangkauan Terhadap Kantor Desa Gunosari")
jangkauan = Image.open('bondowoso_gunosari/PETA JANGKAUAN KANTOR DESA GUNOSARI.jpg')
st.image(jangkauan)

# PETA KELERENGAN
st.header(":arrow_forward: Peta Kelerengan Desa Gunosari")
kelerengan = Image.open('bondowoso_gunosari/PETA KELERENGAN GUNOSARI BONDOWOSO.jpg')
st.image(kelerengan)

# PETA LUAS PERSIL
st.header(":arrow_forward: Peta Klasifikasi Luas Persil Desa Gunosari")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
luas = Image.open('bondowoso_gunosari/PETA KLASIFIKASI LUAS PERSIL GUNOSARI.jpg')
col1.image(luas)
col2.markdown("")
labels = '< 100 m²', '100 - 400 m²', '400 - 1000 m²', '1000 - 2000 m²', '2000 - 5000 m²', '> 5000 m²'
sizes = [124, 198, 930, 746, 699, 198]
...
# PETA PETANI GUREM
st.header(":arrow_forward: Peta Klasifikasi Petani Gurem Desa Gunosari")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
petani_gurem = Image.open('bondowoso_gunosari/PETA KLASIFIKASI PETANI GUREMGUNOSARI.jpg')
...
# PETA TATA GUNA
st.header(":arrow_forward: Peta Tata Guna Lahan Desa Gunosari")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
tata_guna_lahan = Image.open('bondowoso_gunosari/PETA TATA GUNA LAHAN GUNOSARI.jpg')
col1.image(tata_guna_lahan)
col2.markdown("")
labels = 'Pertanian', 'Pekarangan', 'Perumahan', 'Fasilitas Umum'
sizes = [2006, 49, 1456, 64]
...
st.header(":arrow_forward: Pemeringkatan Level Risiko Desa Gunosari")
...
select_kab = 'BONDOWOSO'
select_desa = 'GUNOSARI'
