...
st.set_page_config(page_title="Desa Worawari, Kecamatan Kebonagung, Kabupaten Pacitan", page_icon=":round_pushpin:", layout="wide")

st.markdown("<h1 style='text-align: center'>Analisis Desa Worawari, Kabupaten Pacitan</h1>"
...
<a href='#peta-persil-desa-worawari'>
<button
...
<a href='#persebaran-responden-desa-worawari'>
<button
...
<a href='#peta-batas-administratif-desa-worawari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-batas-hutan-desa-worawari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px">
Peta Batas Hutan
</button>
...
<a href='#peta-klasifikasi-gender-kepemilikan-lahan-desa-worawari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-jangkauan-terhadap-kantor-desa-worawari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-kelerengan-desa-worawari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Peta Kelerengan
</button>
...
<a href='#peta-klasifikasi-luas-persil-desa-worawari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-klasifikasi-petani-gurem-desa-worawari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Peta Petani Gurem
</button>
...
<a href='#peta-tata-guna-lahan-desa-worawari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#pemeringkatan-level-risiko-desa-worawari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#desa-yang-berada-di-klaster-yang-sama-dengan-desa-worawari-klaster-2'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Desa yang Mirip dengan Worawari
</button>
</a>
...
# PETA PERSIL
st.header(":arrow_forward: Peta Persil Desa Worawari")
coba_map = gpd.read_file('pacitan_worawari/Pacitan_Worawari.shp').to_crs(epsg=4326)
...
# PETA BATAS ADMINISTRATIF
st.header(":arrow_forward: Peta Batas Administratif Desa Worawari")
administratif = Image.open('pacitan_worawari/PETA ADMINISTRASI DESA WORAWARI KEC KEBONAGUNG KAB PACITAN.jpg')
st.image(administratif)

# PETA BATAS HUTAN
st.header(":arrow_forward: Peta Batas Hutan Desa Worawari")
batas_hutan = Image.open('pacitan_worawari/PETA BATAS HUTAN DESA WORA - WARI KABUPATEN PACITAN.jpg')
st.image(batas_hutan)

# PETA GENDER
st.header(":arrow_forward: Peta Klasifikasi Gender Kepemilikan Lahan Desa Worawari")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
gender = Image.open('pacitan_worawari/PETA KLASIFIKASI GENDER KEPEMILIKAN LAHAN DESA WORA - WARI KABUPATEN PACITAN.jpg')
col1.image(gender)
col2.markdown("")
...
st.header(":arrow_forward: Peta Jangkauan Terhadap Kantor Desa Worawari")
jangkauan = Image.open('pacitan_worawari/PETA JANGKAUAN TERHADAP KANTOR DESA WORA - WARI KABUPATEN PACITAN.jpg')
st.image(jangkauan)

# PETA KELERENGAN
st.header(":arrow_forward: Peta Kelerengan Desa Worawari")
kelerengan = Image.open('pacitan_worawari/PETA KELERENGAN DESA WORA - WARI KABUPATEN PACITAN.jpg')
st.image(kelerengan)

# PETA LUAS PERSIL
st.header(":arrow_forward: Peta Klasifikasi Luas Persil Desa Worawari")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
luas = Image.open('pacitan_worawari/PETA KLASIFIKASI LUAS PERSIL DESA WORA - WARI KABUPATEN PACITAN 2ND.jpg')
col1.image(luas)
col2.markdown("")
labels = '< 100 m²', '100 - 400 m²', '400 - 1000 m²', '1000 - 2000 m²', '2000 - 5000 m²', '> 5000 m²'
sizes = [121, 819, 1536, 1163, 893, 196]
...
# PETA PETANI GUREM
st.header(":arrow_forward: Peta Klasifikasi Petani Gurem Desa Worawari")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
petani_gurem = Image.open('pacitan_worawari/PETA KLASIFIKASI PERSIL PETANI GUREM DESA WORAWARI KEC KEBONAGUNG KAB PACITAN.jpg')
...
# PETA TATA GUNA
st.header(":arrow_forward: Peta Tata Guna Lahan Desa Worawari")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
tata_guna_lahan = Image.open('pacitan_worawari/PETA TATA GUNA LAHAN DESA WORAWARI KEC KEBONAGUNG KAB PACITAN.jpg')
col1.image(tata_guna_lahan)
col2.markdown("")
labels = 'Pertanian', 'Bangunan', 'Fasilitas Umum', 'Perikanan'
sizes = [4146, 367, 19, 196]
...
st.header(":arrow_forward: Pemeringkatan Level Risiko Desa Worawari")
