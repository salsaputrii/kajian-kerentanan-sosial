...
st.set_page_config(page_title="Desa Bajang, Kecamatan Ngluyu, Kabupaten Nganjuk", page_icon=":round_pushpin:", layout="wide")
st.markdown("<h1 style='text-align: center'>Analisis Desa Bajang, Kabupaten Nganjuk</h1>"
...
<a href='#peta-persil-desa-bajang'>
<button
...
<a href='#persebaran-responden-desa-bajang'>
<button
...
<a href='#peta-batas-administratif-desa-bajang'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-batas-hutan-desa-bajang'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px">
Peta Batas Hutan
</button>
...
<a href='#peta-klasifikasi-gender-kepemilikan-lahan-desa-bajang'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-jangkauan-terhadap-kantor-desa-bajang'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-kelerengan-desa-bajang'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Peta Kelerengan
</button>
...
<a href='#peta-klasifikasi-luas-persil-desa-bajang'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-klasifikasi-petani-gurem-desa-bajang'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Peta Petani Gurem
</button>
...
<a href='#peta-tata-guna-lahan-desa-bajang'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#pemeringkatan-level-risiko-desa-bajang'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#desa-yang-berada-di-klaster-yang-sama-dengan-desa-bajang-klaster-2'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Desa yang Mirip dengan Bajang
</button>
</a>
...
# PETA PERSIL
st.header(":arrow_forward: Peta Persil Desa Bajang")
coba_map = gpd.read_file('nganjuk_bajang/Nganjuk_Bajang.shp').to_crs(epsg=4326)
...
# PETA BATAS ADMINISTRATIF
st.header(":arrow_forward: Peta Batas Administratif Desa Bajang")
administratif = Image.open('nganjuk_bajang/PETA BATAS ADMINISTRASI BAJANG.jpg')
st.image(administratif)

# PETA BATAS HUTAN
st.header(":arrow_forward: Peta Batas Hutan Desa Bajang")
batas_hutan = Image.open('nganjuk_bajang/PETA BATAS HUTAN DESA BAJANG NGANJUKupdate.jpg')
st.image(batas_hutan)

# PETA GENDER
st.header(":arrow_forward: Peta Klasifikasi Gender Kepemilikan Lahan Desa Bajang")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
gender = Image.open('nganjuk_bajang/PETA KLASIFIKASI GENDER BAJANG.jpg')
col1.image(gender)
col2.markdown("")
...
st.header(":arrow_forward: Peta Jangkauan Terhadap Kantor Desa Bajang")
jangkauan = Image.open('nganjuk_bajang/PETA JANGKAUAN TERHADAP KANTOR  DESA BAJANG NGANJUKupdate.jpg')
st.image(jangkauan)

# PETA KELERENGAN
st.header(":arrow_forward: Peta Kelerengan Desa Bajang")
kelerengan = Image.open('nganjuk_bajang/PETAKELERENGAN DESA BAJANG NGANJUK.jpg')
st.image(kelerengan)

# PETA LUAS PERSIL
st.header(":arrow_forward: Peta Klasifikasi Luas Persil Desa Bajang")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
luas = Image.open('nganjuk_bajang/PETA KLASIFIKASI LUAS DESA BAJANG NGANJUKupdate.jpg')
col1.image(luas)
col2.markdown("")
labels = '< 100 m²', '100 - 400 m²', '400 - 1000 m²', '1000 - 2000 m²', '2000 - 5000 m²', '> 5000 m²'
sizes = [7, 180, 191, 138, 97, 8]
...
# PETA PETANI GUREM
st.header(":arrow_forward: Peta Klasifikasi Petani Gurem Desa Bajang")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
petani_gurem = Image.open('nganjuk_bajang/PETA KLASIFIKASI PETANIGUREM BAJANG.jpg')
...
# PETA TATA GUNA
st.header(":arrow_forward: Peta Tata Guna Lahan Desa Bajang")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
tata_guna_lahan = Image.open('nganjuk_bajang/PETA TATA GUNA LAHAN BAJANG.jpg')
...
st.header(":arrow_forward: Pemeringkatan Level Risiko Desa Bajang")
