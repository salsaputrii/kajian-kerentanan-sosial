...
st.set_page_config(page_title="Desa Petung, Kecamatan Dongko, Kabupaten Trenggalek", page_icon=":round_pushpin:", layout="wide")

st.markdown("<h1 style='text-align: center'>Analisis Desa Petung, Kabupaten Trenggalek</h1>"
...
<a href='#peta-persil-desa-petung'>
<button
...
<a href='#persebaran-responden-desa-petung'>
<button
...
<a href='#peta-batas-administratif-desa-petung'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-batas-hutan-desa-petung'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px">
Peta Batas Hutan
</button>
...
<a href='#peta-klasifikasi-gender-kepemilikan-lahan-desa-petung'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-jangkauan-terhadap-kantor-desa-petung'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-kelerengan-desa-petung'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Peta Kelerengan
</button>
...
<a href='#peta-klasifikasi-luas-persil-desa-petung'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-klasifikasi-petani-gurem-desa-petung'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Peta Petani Gurem
</button>
...
<a href='#peta-tata-guna-lahan-desa-petung'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#pemeringkatan-level-risiko-desa-petung'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#desa-yang-berada-di-klaster-yang-sama-dengan-desa-petung-klaster-4'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Desa yang Mirip dengan Petung
</button>
</a>
...
# PETA PERSIL
st.header(":arrow_forward: Peta Persil Desa Petung")
coba_map = gpd.read_file('trenggalek_petung/Trenggalek_Petung.shp').to_crs(epsg=4326)
...
# PETA BATAS ADMINISTRATIF
st.header(":arrow_forward: Peta Batas Administratif Desa Petung")
administratif = Image.open('trenggalek_petung/PETA ADMINISTRASI PETUNG.jpg')
st.image(administratif)

# PETA BATAS HUTAN
st.header(":arrow_forward: Peta Batas Hutan Desa Petung")
batas_hutan = Image.open('trenggalek_petung/PETA BATAS HUTAN PETUNG.jpg')
st.image(batas_hutan)

# PETA GENDER
st.header(":arrow_forward: Peta Klasifikasi Gender Kepemilikan Lahan Desa Petung")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
gender = Image.open('trenggalek_petung/PETA GENDER KEPEMILIKAN LAHAN PETUNG.jpg')
col1.image(gender)
col2.markdown("")
...
st.header(":arrow_forward: Peta Jangkauan Terhadap Kantor Desa Petung")
jangkauan = Image.open('trenggalek_petung/PETA JANGKAUAN TERHADAP KANTOR DESA PETUNG.jpg')
st.image(jangkauan)

# PETA KELERENGAN
st.header(":arrow_forward: Peta Kelerengan Desa Petung")
kelerengan = Image.open('trenggalek_petung/PETA KELERENGAN PETUNG.jpg')
st.image(kelerengan)

# PETA LUAS PERSIL
st.header(":arrow_forward: Peta Klasifikasi Luas Persil Desa Petung")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
luas = Image.open('trenggalek_petung/PETA KLASIFIKASI LUAS PERSIL PETUNG.jpg')
col1.image(luas)
col2.markdown("")
labels = '< 100 m²', '100 - 400 m²', '400 - 1000 m²', '1000 - 2000 m²', '2000 - 5000 m²', '> 5000 m²'
sizes = [167, 884, 2134, 1526, 668, 46]
...
# PETA PETANI GUREM
st.header(":arrow_forward: Peta Klasifikasi Petani Gurem Desa Petung")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
petani_gurem = Image.open('trenggalek_petung/PETA PETANI GUREM PETUNG.jpg')
...
# PETA TATA GUNA
st.header(":arrow_forward: Peta Tata Guna Lahan Desa Petung")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
tata_guna_lahan = Image.open('trenggalek_petung/PETA TATA GUNA LAHAN PETUNG.jpg')
...
st.header(":arrow_forward: Pemeringkatan Level Risiko Desa Petung")
