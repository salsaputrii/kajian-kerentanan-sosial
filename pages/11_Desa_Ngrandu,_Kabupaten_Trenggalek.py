...
st.set_page_config(page_title="Desa Ngrandu, Kecamatan Suruh, Kabupaten Trenggalek", page_icon=":round_pushpin:", layout="wide")
st.markdown("<h1 style='text-align: center'>Analisis Desa Ngrandu, Kabupaten Trenggalek</h1>"
...
<a href='#peta-persil-desa-ngrandu'>
<button
...
<a href='#persebaran-responden-desa-ngrandu'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px">
...
<a href='#peta-batas-administratif-desa-ngrandu'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px">
...
<a href='#peta-batas-hutan-desa-ngrandu'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px">
Peta Batas Hutan
</button>
...
<a href='#peta-klasifikasi-gender-kepemilikan-lahan-desa-ngrandu'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-jangkauan-terhadap-kantor-desa-ngrandu'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-kelerengan-desa-ngrandu'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Peta Kelerengan
</button>
...
<a href='#peta-klasifikasi-luas-persil-desa-ngrandu'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-klasifikasi-petani-gurem-desa-ngrandu'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Peta Petani Gurem
</button>
...
<a href='#peta-tata-guna-lahan-desa-ngrandu'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#pemeringkatan-level-risiko-desa-ngrandu'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#desa-yang-berada-di-klaster-yang-sama-dengan-desa-ngrandu-klaster-4'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Desa yang Mirip dengan Ngrandu
</button>
</a>
...
# PETA PERSIL
st.header(":arrow_forward: Peta Persil Desa Ngrandu")
coba_map = gpd.read_file('trenggalek_ngrandu/Trenggalek_Ngrandu.shp').to_crs(epsg=4326)
...
# PETA BATAS ADMINISTRATIF
st.header(":arrow_forward: Peta Batas Administratif Desa Ngrandu")
administratif = Image.open('trenggalek_ngrandu/PETA ADMINISTRASI NGRANDU.jpg')
st.image(administratif)

# PETA BATAS HUTAN
st.header(":arrow_forward: Peta Batas Hutan Desa Ngrandu")
batas_hutan = Image.open('trenggalek_ngrandu/PETA BATAS HUTAN NGRANDU.jpg')
st.image(batas_hutan)

# PETA GENDER
st.header(":arrow_forward: Peta Klasifikasi Gender Kepemilikan Lahan Desa Ngrandu")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
gender = Image.open('trenggalek_ngrandu/PETA GENDER KEPEMILIKAN LAHAN NGRANDU.jpg')
col1.image(gender)
col2.markdown("")
...
st.header(":arrow_forward: Peta Jangkauan Terhadap Kantor Desa Ngrandu")
jangkauan = Image.open('trenggalek_ngrandu/PETA JANGKAUAN TERHADAP KANTOR DESA NGRANDU.jpg')
st.image(jangkauan)

# PETA KELERENGAN
st.header(":arrow_forward: Peta Kelerengan Desa Ngrandu")
kelerengan = Image.open('trenggalek_ngrandu/PETA KELERENGAN NGRANDU.jpg')
st.image(kelerengan)

# PETA LUAS PERSIL
st.header(":arrow_forward: Peta Klasifikasi Luas Persil Desa Ngrandu")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
luas = Image.open('trenggalek_ngrandu/PETA KLASIFIKASI LUAS PERSIL NGRANDU.jpg')
col1.image(luas)
col2.markdown("")
labels = '< 100 m²', '100 - 400 m²', '400 - 1000 m²', '1000 - 2000 m²', '2000 - 5000 m²', '> 5000 m²'
sizes = [63, 353, 1019, 724, 234, 12]
...
# PETA PETANI GUREM
st.header(":arrow_forward: Peta Klasifikasi Petani Gurem Desa Ngrandu")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
petani_gurem = Image.open('trenggalek_ngrandu/PETA PETANI GUREM NGRANDU.jpg')
...
# PETA TATA GUNA
st.header(":arrow_forward: Peta Tata Guna Lahan Desa Ngrandu")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
tata_guna_lahan = Image.open('trenggalek_ngrandu/PETA TATA GUNA LAHAN NGRANDU.jpg')
...
st.header(":arrow_forward: Pemeringkatan Level Risiko Desa Ngrandu")
...
risiko = {
    ...
    'PROBABILITAS/KEMUNGKINAN': ['Sangat Mungkin (4)',
    ...
    'KONSEKUENSI/DAMPAK': ['Katastropis (5)',
                           'Tidak Signifikan (1)',
                           'Tidak Signifikan (1)',
                           'Kecil (2)',
                           'Tidak Signifikan (1)',
    ...
    'TINGKAT RISIKO': ['Sangat Tinggi (20)',
                       'Rendah (1)',
                       'Rendah (1)',
                       'Menengah (8)',
                       'Menengah (4)',
