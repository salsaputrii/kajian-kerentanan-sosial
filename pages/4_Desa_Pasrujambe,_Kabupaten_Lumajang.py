...
st.set_page_config(page_title="Desa Pasrujambe, Kecamatan Pasrujambe, Kabupaten Lumajang", page_icon=":round_pushpin:", layout="wide")

st.markdown("<h1 style='text-align: center'>Analisis Desa Pasrujambe, Kabupaten Lumajang</h1>"
...
<a href='#peta-persil-desa-pasrujambe'>
<button
...
<a href='#persebaran-responden-desa-pasrujambe'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px">
...
<a href='#peta-batas-administratif-desa-pasrujambe'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-batas-hutan-desa-pasrujambe'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px">
Peta Batas Hutan
</button>
...
<a href='#peta-klasifikasi-gender-kepemilikan-lahan-desa-pasrujambe'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-jangkauan-terhadap-kantor-desa-pasrujambe'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-kelerengan-desa-pasrujambe'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Peta Kelerengan
</button>
...
<a href='#peta-klasifikasi-luas-persil-desa-pasrujambe'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-klasifikasi-petani-gurem-desa-pasrujambe'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Peta Petani Gurem
</button>
...
<a href='#peta-tata-guna-lahan-desa-pasrujambe'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#pemeringkatan-level-risiko-desa-pasrujambe'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#desa-yang-berada-di-klaster-yang-sama-dengan-desa-pasrujambe-klaster-2'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Desa yang Mirip dengan Pasrujambe
</button>
</a>
...
# ------------------------------------------------ANALISIS SPASIAL------------------------------------------------------
# st.header("Analisis Spasial")

# PETA PERSIL
st.header(":arrow_forward: Peta Persil Desa Pasrujambe")
coba_map = gpd.read_file('lumajang_pasrujambe/Lumajang_Pasrujambe.shp').to_crs(epsg=4326)
...
st.header(":arrow_forward: Persebaran Responden Desa Pasrujambe")
col1, col2 = st.columns([1.5, 1.5])
col1.markdown("")
labels = 'Kelompok Non rentan', 'Lokasi Khusus', 'KTP Luar', 'Pendatang', 'Kelompok Rentan', 'Konflik'
sizes = [2, 2, 0, 2, 16, 3]
colors = ['#035f03','#5b8915', '#a5c30b', '#fcfb03', '#ecba29', '#fe2201']
...
# PETA BATAS ADMINISTRATIF
st.header(":arrow_forward: Peta Batas Administratif Desa Pasrujambe")
administratif = Image.open('lumajang_pasrujambe/PETA BATAS ADMINISTRASI PASRUJAMBE LUMAJANG.jpg')
st.image(administratif)

# PETA BATAS HUTAN
st.header(":arrow_forward: Peta Batas Hutan Desa Pasrujambe")
batas_hutan = Image.open('lumajang_pasrujambe/PETA BATAS HUTAN PASRUJAMBE LUMAJANG.jpg')
st.image(batas_hutan)

# PETA GENDER
st.header(":arrow_forward: Peta Klasifikasi Gender Kepemilikan Lahan Desa Pasrujambe")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
gender = Image.open('lumajang_pasrujambe/PETA GENDER KEPEILIKAN LAHAN PASRUJAMBE LUMAJANG.jpg')
col1.image(gender)
col2.markdown("")
...
st.header(":arrow_forward: Peta Jangkauan Terhadap Kantor Desa Pasrujambe")
jangkauan = Image.open('lumajang_pasrujambe/PETA JANGKAUAN TERHADAP KANTOR DESA PASRUJAMBE LUMAJANG.jpg')
st.image(jangkauan)

# PETA KELERENGAN
st.header(":arrow_forward: Peta Kelerengan Desa Pasrujambe")
kelerengan = Image.open('lumajang_pasrujambe/PETA KELERENGAN PASRUJAMBE LUMAJANG.jpg')
st.image(kelerengan)

# PETA LUAS PERSIL
st.header(":arrow_forward: Peta Klasifikasi Luas Persil Desa Pasrujambe")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
luas = Image.open('lumajang_pasrujambe/PETA KLASIFIKASI LUAS PERSIL PASRUJAMBE LUMAJANG.jpg')
col1.image(luas)
col2.markdown("")
labels = '< 100 m²', '100 - 400 m²', '400 - 1000 m²', '1000 - 2000 m²', '2000 - 5000 m²', '5000 - 63788 m²'
sizes = [59, 894, 1443, 1087, 615, 80]
...
# PETA PETANI GUREM
st.header(":arrow_forward: Peta Klasifikasi Petani Gurem Desa Pasrujambe")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
petani_gurem = Image.open('lumajang_pasrujambe/PETA PETANI GUREM PASRUJAMBE LUMAJANG.jpg')
...
# PETA TATA GUNA
st.header(":arrow_forward: Peta Tata Guna Lahan Desa Pasrujambe")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
tata_guna_lahan = Image.open('lumajang_pasrujambe/PETA TATA GUNA LAHAN PASRUJAMBE LUMAJANG.jpg')
col1.image(tata_guna_lahan)
col2.markdown("")
labels = 'Pertanian', 'Pekarangan', 'Bangunan', 'Fasilitas Umum'
sizes = [2436, 43, 1649, 50]
...
st.header(":arrow_forward: Pemeringkatan Level Risiko Desa Pasrujambe")
