...
st.set_page_config(page_title="Desa Gunungsari, Kecamatan Maesan, Kabupaten Bondowoso", page_icon=":round_pushpin:", layout="wide")
st.markdown("<h1 style='text-align: center'>Analisis Desa Gunungsari, Kabupaten Bondowoso</h1>"
...
<a href='#peta-persil-desa-gunungsari'>
<button
...
<a href='#persebaran-responden-desa-gunungsari'>
<button
...
<a href='#peta-batas-administratif-desa-gunungsari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-batas-hutan-desa-gunungsari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px">
Peta Batas Hutan
</button>
...
<a href='#peta-jangkauan-terhadap-kantor-desa-gunungsari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-kelerengan-desa-gunungsari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Peta Kelerengan
</button>
...
<a href='#peta-klasifikasi-luas-persil-desa-gunungsari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-tata-guna-lahan-desa-gunungsari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#pemeringkatan-level-risiko-desa-gunungsari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#desa-yang-berada-di-klaster-yang-sama-dengan-desa-gunungsari-klaster-5'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Desa yang Mirip dengan Gunungsari
</button>
</a>
...
# PETA PERSIL
st.header(":arrow_forward: Peta Persil Desa Gunungsari")
coba_map = gpd.read_file('bondowoso_gunungsari/Bondowoso_Gunungsari.shp').to_crs(epsg=4326)
...
st.header(":arrow_forward: Persebaran Responden Desa Gunungsari")
col1, col2 = st.columns([1.5, 1.5])
col1.markdown("")
labels = 'Kelompok Non rentan', 'Lokasi Khusus', 'KTP Luar', 'Pendatang', 'Belum Mendapat Kuota', 'Kelompok Rentan', 'Konflik'
sizes = [0, 2, 1, 2, 1, 16, 3]
colors = ['#035f03','#5b9a01', '#adcf00', '#ffff00', '#ffbe00', '#ff7701', '#ff2602']
...
# PETA BATAS ADMINISTRATIF
st.header(":arrow_forward: Peta Batas Administratif Desa Gunungsari")
administratif = Image.open('bondowoso_gunungsari/PETA B.ADMINISTRASI GUNUNGSARI BONDOWOSO.jpg')
st.image(administratif)

# PETA BATAS HUTAN
st.header(":arrow_forward: Peta Batas Hutan Desa Gunungsari")
batas_hutan = Image.open('bondowoso_gunungsari/PETA B.HUTAN GUNUNGSARI BONDOWOSO.jpg')
st.image(batas_hutan)

# PETA JANGAKAUAN KE KANTOR DESA
st.header(":arrow_forward: Peta Jangkauan Terhadap Kantor Desa Gunungsari")
jangkauan = Image.open('bondowoso_gunungsari/PETA JANGKAUAN KANTOR DESA GUNUNGSARI.jpg')
st.image(jangkauan)

# PETA KELERENGAN
st.header(":arrow_forward: Peta Kelerengan Desa Gunungsari")
kelerengan = Image.open('bondowoso_gunungsari/PETA KELERENGAN GUNUNGSARI BONDOWOSO.jpg')
st.image(kelerengan)

# PETA LUAS PERSIL
st.header(":arrow_forward: Peta Klasifikasi Luas Persil Desa Gunungsari")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
luas = Image.open('bondowoso_gunungsari/PETA KLASIFIKASI LUAS PERSIL GUNUNGSARI.jpg')
col1.image(luas)
col2.markdown("")
...
# PETA TATA GUNA
st.header(":arrow_forward: Peta Tata Guna Lahan Desa Gunungsari")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
tata_guna_lahan = Image.open('bondowoso_gunungsari/PETA TATA GUNA LAHAN GUNUNGSARI.jpg')
col1.image(tata_guna_lahan)
col2.markdown("")
labels = 'Pertanian', 'Perumahan'
sizes = [1089, 717]
colors = ['#39a700', '#dadc44']
fig1, ax1 = plt.subplots()
ax1.pie(sizes, labels=labels, autopct='%1.1f%%', startangle=90, colors=colors)
ax1.axis('equal')
col2.markdown("#")
...
st.header(":arrow_forward: Pemeringkatan Level Risiko Desa Gunungsari")
