...
st.set_page_config(page_title="Desa Argosari, Kecamatan Senduro, Kabupaten Lumajang", page_icon=":round_pushpin:", layout="wide")
st.markdown("<h1 style='text-align: center'>Analisis Desa Argosari, Kabupaten Lumajang</h1>"
...
<a href='#peta-persil-desa-argosari'>
<button
...
<a href='#persebaran-responden-desa-argosari'>
<button
...
<a href='#peta-batas-administratif-desa-argosari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-batas-hutan-desa-argosari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px">
Peta Batas Hutan
</button>
...
<a href='#peta-klasifikasi-gender-kepemilikan-lahan-desa-argosari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-jangkauan-terhadap-kantor-desa-argosari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-kelerengan-desa-argosari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Peta Kelerengan
</button>
...
<a href='#peta-klasifikasi-luas-persil-desa-argosari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#peta-klasifikasi-petani-gurem-desa-argosari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Peta Petani Gurem
</button>
...
<a href='#peta-tata-guna-lahan-desa-argosari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#pemeringkatan-level-risiko-desa-argosari'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
...
<a href='#desa-yang-berada-di-klaster-yang-sama-dengan-desa-argosari-klaster-4'>
<button
style="background-color:#ffffff; border:1px solid #dcdcdc; font-size:15px; padding:12px;">
Desa yang Mirip dengan Argosari
</button>
</a>
</div>
<br>
...
# PETA PERSIL
st.header(":arrow_forward: Peta Persil Desa Argosari")
coba_map = gpd.read_file('lumajang_argosari/Lumajang_Argosari.shp').to_crs(epsg=4326)
...
st.header(":arrow_forward: Persebaran Responden Desa Argosari")
...
# PETA BATAS ADMINISTRATIF
st.header(":arrow_forward: Peta Batas Administratif Desa Argosari")
administratif = Image.open('lumajang_argosari/PETA BATAS ADMINISTRASI ARGOSARI LUMAJANG.jpg')
st.image(administratif)

# PETA BATAS HUTAN
st.header(":arrow_forward: Peta Batas Hutan Desa Argosari")
batas_hutan = Image.open('lumajang_argosari/PETA BATAS HUTAN ARGOSARI LUMAJANG.jpg')
st.image(batas_hutan)

# PETA GENDER
st.header(":arrow_forward: Peta Klasifikasi Gender Kepemilikan Lahan Desa Argosari")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
gender = Image.open('lumajang_argosari/PETA GENDER KEPEILIKAN LAHAN ARGOSARI LUMAJANG.jpg')
col1.image(gender)
col2.markdown("")
...
st.header(":arrow_forward: Peta Jangkauan Terhadap Kantor Desa Argosari")
jangkauan = Image.open('lumajang_argosari/PETA JANGKAUAN TERHADAP KANTOR DESA ARGOSARI LUMAJANG.jpg')
st.image(jangkauan)

# PETA KELERENGAN
st.header(":arrow_forward: Peta Kelerengan Desa Argosari")
kelerengan = Image.open('lumajang_argosari/PETA KELERENGAN ARGOSARI LUMAJANG.jpg')
st.image(kelerengan)

# PETA LUAS PERSIL
st.header(":arrow_forward: Peta Klasifikasi Luas Persil Desa Argosari")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
luas = Image.open('lumajang_argosari/PETA KLASIFIKASI LUAS PERSIL ARGOSARI LUMAJANG.jpg')
col1.image(luas)
col2.markdown("")
labels = '< 100 m²', '100 - 400 m²', '400 - 1000 m²', '1000 - 2000 m²', '2000 - 5000 m²', '5000 - 36305 m²'
sizes = [274, 1044, 1147, 1268, 1028, 207]
...
# PETA PETANI GUREM
st.header(":arrow_forward: Peta Klasifikasi Petani Gurem Desa Argosari")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
petani_gurem = Image.open('lumajang_argosari/PETA PETANI GUREM ARGOSARI LUMAJANG.jpg')
...
# PETA TATA GUNA
st.header(":arrow_forward: Peta Tata Guna Lahan Desa Argosari")
col1, col2 = st.columns([3.5, 1.5])
col1.markdown("")
tata_guna_lahan = Image.open('lumajang_argosari/PETA TATA GUNA LAHAN ARGOSARI LUMAJANG.jpg')
col1.image(tata_guna_lahan)
col2.markdown("")
labels = 'Pertanian', 'Bangunan', 'Fasilitas Umum'
sizes = [3883, 1058, 27]
colors = ['#3aa700','#ffaa01', '#fe2201']
fig1, ax1 = plt.subplots()
ax1.pie(sizes, labels=labels, autopct='%1.1f%%', startangle=90, colors=colors)
ax1.axis('equal')
col2.markdown("#")
...
st.header(":arrow_forward: Pemeringkatan Level Risiko Desa Argosari")
...
select_kab = 'LUMAJANG'
select_desa = 'ARGOSARI'

result_data = data[(data['KABUPATEN'] == select_kab) & (data['DESA'] == select_desa)]
klaster_sebaris = result_data.iloc[0]['klaster']

st.title(f":arrow_forward: Desa yang berada di klaster yang sama dengan Desa {select_desa} (Klaster {klaster_sebaris})")
